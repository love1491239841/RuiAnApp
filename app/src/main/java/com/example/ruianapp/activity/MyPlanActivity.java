...
public class MyPlanActivity extends AppCompatActivity {
    ...
    private void initView(){
        recyclerView= (RecyclerView) findViewById(R.id.myplan_recycler);
    ...
    private void initData(final String userId){
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    UtlisOkhttp.sendIdOkHttpRequest(userId, Constants.MyPlan_URL,new okhttp3.Callback(){
                        @Override
    ...
    private void showResponse(final String response) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try{
                    myPlanAdapter=new MyPlanAdapter(JsonGet.myPlan(response),MyPlanActivity.this);
