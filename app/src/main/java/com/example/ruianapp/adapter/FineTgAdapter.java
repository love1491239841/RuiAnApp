    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        ((RwHolder)holder).view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                        ...
                        new AlertDialog.Builder(context)
                                ...
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        if (Gctg.getWord() == null){
                                            Toast.makeText(context, "此罚款单没有附件", Toast.LENGTH_SHORT).show();
                                        }else {
                                            String url = Constants.IMGURL+Gctg.getWord();
                                            String path = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator+"RuiAn/"+Gctg.getGcmc()+new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())+".doc";
                                ...
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        if (Gctg.getPdf() == null){
                                            ...
                                            String url = Constants.IMGURL+Gctg.getPdf();
                                            String path = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator+"RuiAn/"+Gctg.getGcmc()+new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())+".pdf";
                                            downloadFile(url,path);
                                        }
                ...
                popupWindow.showAsDropDown(((RwHolder)holder).Gctg_item_saved, Gravity.RIGHT,Gravity.RIGHT);
